...
<svg xmlns="http://www.w3.org/2000/svg" width="1024" height="1024" viewBox="0 0 1024 1024">
  ...
  <g font-family="Liberation Sans, Helvetica, Arial, sans-serif" font-weight="bold"
    ...
    <text x="240" y="700" font-size="520" fill="url(#redgloss)">6</text>
    <text x="512" y="678" font-size="330" fill="url(#darkgloss)">+</text>
    <text x="784" y="700" font-size="520" fill="url(#redgloss)">7</text>
  </g>
